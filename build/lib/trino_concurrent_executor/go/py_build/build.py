# python build stubs for package trino_concurrent_executor
...
mod = Module('_trino_concurrent_executor')
mod.add_include('"trino_concurrent_executor_go.h"')
...
add_checked_string_function(mod, 'trino_concurrent_executor_HelloWorld', retval('char*'), [])

mod.generate(open('trino_concurrent_executor.c', 'w'))
