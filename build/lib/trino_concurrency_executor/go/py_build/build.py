# python build stubs for package trino_concurrency_executor
...
mod = Module('_trino_concurrency_executor')
mod.add_include('"trino_concurrency_executor_go.h"')
...
add_checked_string_function(mod, 'trino_concurrency_executor_HelloWorld', retval('char*'), [])

mod.generate(open('trino_concurrency_executor.c', 'w'))
